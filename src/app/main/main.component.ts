...
export class MainComponent implements OnInit {
  ...
  apps = [
    ...
    {
      icon: 'https://cdn4.iconfinder.com/data/icons/weatherful/72/Cloudy_Sunny-512.png',
      title: 'Weather App',
      subtitle: 'Java EE',
      image: 'assets/img/screenweather.png',
      content: 'Application web indiquant la météo d\'une ville choisie par l\'utilisateur ainsi que les prévisions sur 7 jours.',
      buttonColor: 'basic',
      link: 'https://github.com/adem-m/weather-app',
      ghlink: '',
